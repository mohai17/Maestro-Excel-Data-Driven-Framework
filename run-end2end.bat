...
:: Run all flow files in the Flows directory and output directly to html-detailed format
call maestro test Flows\ --format html-detailed --output Reports\maestro-report.html

if %ERRORLEVEL% NEQ 0 (
    echo [WARNING] One or more test flows failed during execution.
)

echo.
echo ===================================================
echo  Step 3: Verifying Generated Report...
echo ===================================================
if exist "Reports\maestro-report.html" (
    echo [SUCCESS] Detailed report generated at Reports\maestro-report.html
) else (
    echo [WARNING] Failed to generate Reports\maestro-report.html
)
